...
public class CustomMonthView extends MonthView {
    ...
    public CustomMonthView(Context context) {
        ...
        mSolarTermTextPaint.setColor(getResources().getColor(R.color.black));
        mSolarTermTextPaint.setAntiAlias(true);
        mSolarTermTextPaint.setTextAlign(Paint.Align.CENTER);

//        TODO Scheme white cutout keyur
...
//        TODO TODAY COLOR BLUE
        mCurrentDayPaint.setAntiAlias(true);
        mCurrentDayPaint.setStyle(Paint.Style.FILL);
        mCurrentDayPaint.setColor(0xFFeaeaea);
//        mCurrentDayPaint.setColor(getResources().getColor(R.color.blue_primary));
...
//        mSchemeBasicPaint.setMaskFilter(new BlurMaskFilter(28, BlurMaskFilter.Blur.SOLID));
    ...
    protected void onPreviewHook() {
        ...
        mRadius = Math.min(mItemWidth, mItemHeight) / 11 * 6;
    }
    ...
    protected void onDrawScheme(Canvas canvas, Calendar calendar, int x, int y) {
        ...
        if (isSelected) {
            ...
            mPointPaint.setColor(getResources().getColor(R.color.blue_primary));
        }
...
//            canvas.drawCircle(x + mItemWidth - mPadding - mCircleRadius / 2, y + mPadding + mCircleRadius, mCircleRadius, mSchemeBasicPaint);
        ...
        if (calendar.isWeekend() && calendar.isCurrentMonth()) {
            mCurMonthTextPaint.setColor(getResources().getColor(R.color.black));
            mCurMonthLunarTextPaint.setColor(getResources().getColor(R.color.black));
            mSchemeTextPaint.setColor(getResources().getColor(R.color.black));
            mSchemeLunarTextPaint.setColor(getResources().getColor(R.color.black));
            mOtherMonthLunarTextPaint.setColor(getResources().getColor(R.color.black));
            mOtherMonthTextPaint.setColor(getResources().getColor(R.color.black));
        } else {
