...
class EducationDetailVideoAdapter(
    val videoList: List<CategoryVideo>,
    val adapterItemClick: (Int) -> Unit,
    var playPosition: Int
) : RecyclerView.Adapter<EducationDetailVideoAdapter.EducationDetailVideoHolder>() {
            ...
            try {
                ...
                if (videoList.isNotEmpty()) {
                    ...
                    binding.rowTvVideoDescription.text = setMinuteText(
                        ...
                        currentVideoModel.minute.toString(),
                        currentVideoModel.second.toString()
                    )
